...
public class CreateTables {
	...
	public static String CreateTableReceipts = "create table RECEIPTS("
           ...
           + "db_animal_id INT FOREIGN KEY,"
           + "db_personaddress_id INT FOREIGN KEY,"
	   + "db_receipt_date DATE,"
	   + "db_shelter_id INT FOREIGN KEY,"
	   + "db_receipt_log_number INT)";
	...
	public static String CreateTableTreatments = "create table TREATMENTS("
	   ...
	   + "db_vet_id INT FOREIGN KEY),"
	   + "db_animal_id INT FOREIGN KEY),"
	   + "db_invoice_id INT FOREIGN KEY),"
